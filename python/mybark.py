...
script = """
Greetings! Have you been introduced to ShortcutAI's innovative text-to-audio feature yet?
It's incredible! This advanced technology generates audio that's almost indistinguishable from human speech.
It analyzes the subtleties of human speech, and mimics them in its output.
Many have found applications for this technology in producing audiobooks and podcasts.
Some publishers have already incorporated ShortcutAI in their audiobook creation processes.
Think of it like this - it’s as if you now have your own personal voiceover artist.
ShortcutAI is poised to revolutionize the text-to-audio technology domain.
""".replace("\n", " ").strip()
...
for idx, sentence in enumerate(sentences):
    ...
    write_wav(f"bark{idx}.wav", SAMPLE_RATE, audio_array)
    pieces += [audio_array, silence.copy()]

audio_array = np.concatenate(pieces)

write_wav("bark_all.wav", SAMPLE_RATE, audio_array)
